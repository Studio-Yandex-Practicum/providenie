...
FUND_QUESTIONS = {
    ...
    'REQUEST_DATE': {
        ...
        key.TEXT: 'Дата обращения в Фонд "Провидение"',
    ...
    'SOCIAL_NETWORKS': {
        ...
        key.TEXT: 'Прикрепите ссылку на социальную сеть',
        key.HINT: 'Пример: vk.com/fond_providenie"',
    },
    'PARENTS_WORK_PLACE': {
        key.TITLE: 'Место работы родителей',
        key.TEXT: 'Укажите место работы родителей',

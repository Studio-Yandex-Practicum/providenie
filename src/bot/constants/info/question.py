...
COMMON_QUESTIONS = {
    ...
    'CITY': {
        ...
        key.HINT: ('Пожалуйста, введите город проживания, например: Ростов'),
    },
    'FAMILY_MEMBERS': {
        key.TITLE: 'Тип семьи',
        key.TEXT: 'Укажите тип семьи (полная/неполная)',
        key.HINT: ('Пожалуйста, укажите тип семьи, например: полная'),
    },
    'WHERE_GOT_INFO': {
    ...
    'ADDITIONAL_CHATS': {
        ...
        key.TEXT: (
            ...
            + '\n- '.join([
                chat.get(key.BUTTON_TEXT) for chat in option.CHAT.values()
            ])
        ),
        key.HINT: (
            'Пожалуйста, укажите, В какие ещё чаты Вы хотели бы вступить, '
            'например: Да, хочу вступить в "Смотри на мир", "Дети с '
            'гидроцефалией"'
        ),
    },
}
...
LONG_QUESTIONS = {
    ...
    'CHILD_BIRTHDAY': {
        ...
        key.HINT: ('Пожалуйста, введите дату рождения, например: 09.03.2023'),
    },
    'CHILD_BIRTH_PLACE': {
        key.TITLE: 'Место рождения ребенка',
        key.TEXT: 'Введите место рождения ребенка',
        key.HINT: (
            'Пожалуйста, введите место рождения ребенка, например: Челябинск'
        ),
    },
    'CHILD_BIRTH_DATE': {
    ...
    'CHILD_BIRTH_HEIGHT': {
        ...
        key.HINT: ('Пожалуйста, введите рост ребенка в см, например: 40'),
    },
    'CHILD_DIAGNOSIS': {
        key.TITLE: 'Диагнозы ребенка',
        key.TEXT: ('Введите диагнозы ребенка на момент обращения'),
        key.HINT: (
...
FUND_QUESTIONS = {
    ...
    'REQUIRED_THERAPY': {
        ...
        key.HINT: (
            'Пожалуйста, укажите требуемое лечение, например: Шунтирование'
        ),
    },
    'REQUEST_GOAL': {

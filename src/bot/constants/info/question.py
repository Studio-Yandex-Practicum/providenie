...
COMMON_QUESTIONS = {
    ...
    'WHERE_GOT_INFO': {
        ...
        key.HINT: (
            'Пожалуйста, укажите как Вы узнали о Фонде. '
            'Пример: увидел информационный пост на Яндекс Дзен'
        ),
    },
    'ADDITIONAL_CHATS': {
        ...
        key.HINT: (
            'Пожалуйста, укажите, хотели бы Вы вступить в другие чаты? '
            'Пример: Да, хочу вступить в "Смотри на мир", "Шунтята"'
        ),
    }
}
...
FUND_QUESTIONS = {
    'ADDRESS': {
        ...
        key.HINT: (
            ...
            '\nПример: Ростов, ул. Моравского, д.6, кв. 1'
        ),
    },
    'REQUIRED_THERAPY': {
    ...
    'ANOTHER_FUND_MEMBER': {
        ...
        key.HINT: (
            'Пожалуйста, укажите, состоите ли Вы в другом фонде.'
            '\nПример: Да, Фонд «Название Фонда»'
        ),
    },
}

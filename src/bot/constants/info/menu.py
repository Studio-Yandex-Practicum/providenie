...
ALL_MENU = {
    ...
    f'{key.MENU}_DONATORS_FAQ': {
        ...
        key.DESCRIPTION: (
            'Здесь вы можете найти ответы на наиболее часто задаваемые '
            'вопросы жертвователей Фонда'
        ),
    ...
    f'{key.MENU}_ASK_QUESTION': {
        ...
        key.DESCRIPTION: (
            'Чтобы задать вопрос, заполните, пожалуйста, нашу анкету'
        ),
    ...
    f'{key.MENU}_DONATION': {
        ...
        key.DESCRIPTION: (
            'Благодаря Вашей поддержке слабовидящие и рожденные раньше срока '
            'дети смогут вовремя получить помощь: попасть на операцию и '
            'сохранить зрение, пройти необходимые обследования и лечение при '
            'тугоухости, дцп или эпилепсии. Это помогает нашим подопечным '
            'избежать инвалидности и меняет их жизнь к лучшему на всю жизнь.'
        ),

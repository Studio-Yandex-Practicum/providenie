...
ALL_MENU = {
    ...
    f"{key.MENU}_ABOUT": {
        ...
        key.DESCRIPTION: (
            ...
            "растут дети, рожденные раньше срока."
            "\n\nНаша миссия – спасти зрение "
            "детей, помочь им избежать инвалидности и улучшить качество жизни "
            "их семей. "
            "\n\nУ нашего фонда “Провидение” также есть чаты поддержки в WhatsApp: "
            "по зрению и развитию детей."
            "\nДля добавления можно прислать запрос на номер 89169814619 администратору Юлии."

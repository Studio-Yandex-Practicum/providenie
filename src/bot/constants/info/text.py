SHARE = (
    '\n\nЧтобы оставаться в курсе последних новостей, рекомендуем Вам '
    'подписаться на наши страницы в социальных сетях: '
    "\n\n<a href='https://fond-providenie.ru/'>Сайт Благотворительного Фонда "
    '“Провидение”</a>'
    "\n<a href='https://vk.com/fond_providenie '>Группа Вконтакте</a>"
    "\n<a href='https://zen.yandex.ru/fond_providenie'>Наша страница на "
    'Яндекс.Дзен</a>'
    "\n<a href='https://t.me/providenie_fond'>Новостной канал Telegram</a>"
    "\n<a href='https://www.instagram.com/fond_providenie/'>Наша страница в "
    'Instagram</a>'
    "\n<a href='https://dobro.mail.ru/funds/blagotvoritelnyij-fond-pomoschi"
    "-nedonoshennyim-detyam-i-ih-semyam-providenie-2/'>Наша страница на "
    'Mail.ru</a>'
    "\n<a href='https://youtube.com/channel/UC_co5lBatw_pA2DceKCqZfg'>Наш "
    'канал на Youtube</a>'
)
...
START = (
    ...
    '\nМы помогаем детям, родившимся раньше срока, лучше видеть, слышать и '
    'разговаривать, а также поддерживаем их родителей.'
    '\n\nНаша миссия – спасти зрение детей, помочь им избежать инвалидности '
    'и улучшить качество жизни их семей.'
    f'{SHARE}'
)
...
REQUIRED_DOCUMENTS = (
    '<b>Внимание</b>!\n'
    'Cписок документов, которые необходимо прислать координатору Фонда на '
    'почту terekhova@fond-provideniе.ru:'
    '\n- Справка о многодетности, малообеспеченности, инвалидности (фото/скан)'
    '\n- Справка 2-НДФЛ родителей или любая форма справки, подтверждающая '
    'доход родителей (фото/скан)'
    ...
    '\n- Фото (не менее 10 шт) и видео ребёнка в хорошем качестве'
    '\n- Напишите Вашу подробную историю'
    f'\n{SHARE}'
)

...
BTN_TO_DONATION = "Сделать пожертвование"
...
MSG_RESPONSE_JOIN_CHAT = """
Спасибо за ваши ответы!
В течение 3 рабочих дней Вы получите приглашение в чат после рассмотрения заявки нашим куратором
"""

MSG_RESPONSE_BECOME_VOLUNTEER = """
Спасибо за ваши ответы!
...
MSG_START = "Выберите интересующий вас пункт меню:"
...
Спасибо за ваши ответы!
Ваша заявка отправлена и скоро наш куратор свяжется с Вами в течение 7 рабочих дней.

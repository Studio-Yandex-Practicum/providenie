...
CHAT = {
    f"{key.OPTION}_BABY": {
        ...
        key.BUTTON_TEXT: "Дети, рожде‌нные до 1,5 лет",  # TODO Придумать короткое название
        key.DESCRIPTION: (
            ...
            "Для вступления в чат Вам необходимо предоставить информацию для куратора." # TODO Добавить здесь и ниже REQUIRED_DOCUMENTS
    )},
    f"{key.OPTION}_CHILD": {
        key.NAME: "Дети, рожде‌нные раньше срока (старше 1,5 лет)",
        key.BUTTON_TEXT: "Дети, рожде‌нные старше 1,5 лет",  # TODO Придумать короткое название
        key.DESCRIPTION: (
            "В группе для родителей детей, рожде‌нных раньше срока, "
            "информационная и психологическая помощь родителям по любым "

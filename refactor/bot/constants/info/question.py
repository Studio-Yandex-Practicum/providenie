...
VOLUNTEER_QUESTIONS = {
    **SHORT_QUESTIONS,
    "BIRTHDAY": {
        ...
        key.TEXT: "Введите дату своего рождения (ДД.ММ.ГГГГ)",
        key.HINT: "подсказка",
    },
    "CITY": {
        key.TITLE: "Город",
...
LONG_QUESTIONS = {
    ...
    "CHILD_BIRTH_WEIGHT": {
        ...
        key.TEXT: "Введите вес ребенка при рождении (в гр)",
        key.HINT: "подсказка",
    },
    "CHILD_BIRTH_HEIGHT": {
        key.TITLE: "Рост ребенка",
        key.TEXT: "Введите рост ребенка при рождении (в см)",
        key.HINT: "подсказка",
    },
    "CHILD_DIAGNOSIS": {
        key.TITLE: "Диагноз ребенка",
        key.TEXT: "Введите диагнозы ребенка (через запятую при наличии нескольких)",
        key.HINT: "подсказка",
    },
    "WHERE_GOT_INFO": {
...
FUND_QUESTIONS = {
    **LONG_QUESTIONS,
    ...
    "ANOTHER_FUND_MEMBER": {
        ...
        key.TEXT: ("Состоите ли вы в данный момент в каком-либо фонде? "
